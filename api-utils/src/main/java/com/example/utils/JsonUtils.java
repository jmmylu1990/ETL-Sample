...
public class JsonUtils {
	 ...
	 * 
	 * @param jsonContent json字串, String型別
	 * @param beanClass   反序列化後的java bean類別, Class型別
	 ...
	 * @param jsonContent json字串, String型別
	 * @param beanClass   java bean類別, Class型別
	...
	public static String toJsonString(String url, String methodType, Map<String, String> headers) throws Exception {
		headers = Objects.nonNull(headers) ? headers : new HashMap<>();
	 ...
	 * @param jsonContent json字串, String型別
	 * @param fieldName   欲從Json字串中取得的欄位名稱, String型別
