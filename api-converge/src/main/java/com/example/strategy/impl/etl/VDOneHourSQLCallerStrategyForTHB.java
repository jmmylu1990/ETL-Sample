...
@Slf4j
@Component("VDOneHourSQLCallerStrategyForTHB")
public class VDOneHourSQLCallerStrategyForTHB implements SQLCallerStrategy {

	@Value("${vdOneHourForTHB.insertVDOneHour}")
