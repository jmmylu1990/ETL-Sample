...
@Slf4j
@Component("CECIApiETLStrategy")
public class CECIApiETLStrategy extends GeneralApiETLStrategy {
    ...
    public ExtractResult extract(ResourceInfo resourceInfo) throws ResourceException {
        try {
            ...
            JsonNode arrayNode = StreamSupport.stream(tree.get("ETags").spliterator(), false)
