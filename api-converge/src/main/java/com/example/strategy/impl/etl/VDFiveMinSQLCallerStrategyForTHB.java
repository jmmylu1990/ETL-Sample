...
@Slf4j
@Component("VDFiveMinSQLCallerStrategyForTHB")
public class VDFiveMinSQLCallerStrategyForTHB implements SQLCallerStrategy {

	@Value("${vdFiveMinForTHB.insertVDFiveMin}")
