...
@Slf4j
@Component("VDFiveMinSQLCallerStrategyForNFB")
public class VDFiveMinSQLCallerStrategyForNFB implements SQLCallerStrategy {

	@Value("${vdFiveMinForNFB.insertVDFiveMin}")
