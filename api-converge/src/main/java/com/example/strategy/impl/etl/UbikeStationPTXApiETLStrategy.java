...
import com.example.model.dto.source.ptx.ubike.UbikeStationPTX;

import lombok.extern.slf4j.Slf4j;

@Slf4j
@Component("UbikeStationPTXApiETLStrategy")
public class UbikeStationPTXApiETLStrategy extends PtxApiETLStrategy {
	...
	public TransformResult transform(ResourceInfo resourceInfo, ExtractResult extractResult)
		...
		List<Serializable> resultList = resources.stream().map(resource -> {
			...
			List<UbikeStationPTX> beanList = JsonUtils.toBeanList(content, UbikeStationPTX.class);
