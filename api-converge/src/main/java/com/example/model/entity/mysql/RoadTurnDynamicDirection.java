...
@Entity
@Table(name = "dataset.road_turn_dynamic_direction")
@IdClass(RoadTurnDynamicDirectionKey.class)
public @Data class RoadTurnDynamicDirection implements Serializable {
