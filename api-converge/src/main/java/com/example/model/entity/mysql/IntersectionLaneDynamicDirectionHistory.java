...
@Entity
@Table(catalog = "dataset",name = "intersection_lane_dynamic_direction_history")
@IdClass(IntersectionLaneDynamicDirectionHistoryKey.class)
public @Data class IntersectionLaneDynamicDirectionHistory implements Serializable {
    @Id
