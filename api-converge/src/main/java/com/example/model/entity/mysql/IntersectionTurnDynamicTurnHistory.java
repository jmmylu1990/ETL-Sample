...
@Entity
@Table(catalog = "dataset",name="intersection_turn_dynamic_turn_history")
@IdClass(IntersectionTurnDynamicTurnHistoryKey.class)
public @Data class IntersectionTurnDynamicTurnHistory implements Serializable {
